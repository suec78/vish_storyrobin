Vish::Application.configure do
  ...
  config.after_initialize do
    ...
    config.catalogue["categories"] = ["art","biology","chemistry","citizenship","computerScience","economics","education","engineering","foreignLanguages","generalCulture","geography","geology","history","humanities","literature","maths","music","science","physics","technology"]
    config.catalogue["default_categories"] = ["art","technology","chemistry","history","science"]
